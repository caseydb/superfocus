...
import { InstanceProvider, useInstance } from "../Components/Instances";
      ...
      return (
        <div className="bg-white/90 rounded-xl shadow-xl p-8 w-full max-w-md flex flex-col items-center gap-4">
          ...
          <p className="text-gray-600 text-center mb-4">
            The room <span className="font-mono bg-gray-100 px-2 py-1 rounded">{roomUrl}</span> does not exist or has
            been deleted.
          </p>
          <button
